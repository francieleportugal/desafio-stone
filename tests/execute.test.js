...
describe('execute', () => {
    ...
    it('send empty shopping list and emails list, throw error', () => {
        const shoppingList = [];
        const emailList = ['user1@gmail.com', 'user2@gmail.com'];

        expect(() => execute(shoppingList, emailList))
            .toThrow('Lists should not be empty');
    });
    it('send empty e-mail list and emails list, throw error', () => {
        const shoppingList = [
            {
                name: 'item 1',
                price: 1079430,
    ...
    it('send duplicate e-mails, throw error', () => {        
        const shoppingList = [
            {
                name: 'item 1',
                price: 1079430,
